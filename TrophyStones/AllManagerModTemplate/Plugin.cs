...
namespace AllManagerModTemplate
{
    ...
    public class AllManagerModTemplatePlugin : BaseUnityPlugin
    {
        internal const string ModName = "AllManagerModTemplate";
        ...
        public static readonly ManualLogSource AllManagerModTemplateLogger =
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                AllManagerModTemplateLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                AllManagerModTemplateLogger.LogError($"There was an issue loading your {ConfigFileName}");
                AllManagerModTemplateLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
